...
const _funcDoQuiz_001223 = async (rowCells) => {
    ...
    let urlQuiz=`http://192.168.1.101:3010/quizAnywhereV3.html?quiz=001223${QuizPath}` ;
...
const _funcDoQuiz_025233 = async (rowCells) => {
    let QuizKey = rowCells[0].data ;
    console.log(QuizKey) ;
    let urlQuiz=`http://192.168.1.101:3010/quizAnywhereV3.html?quiz=025233/${QuizKey}` ;
    window.open(urlQuiz,"_blank") ;
}
