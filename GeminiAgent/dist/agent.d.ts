...
export declare const thaiWordLearningSchema: z.ZodObject<{
    ...
    cultural_notes: z.ZodOptional<z.ZodString>;
}, "strip", z.ZodTypeAny, {
    word: string;
    level: string;
    translation: {
    ...
    audioURL?: string | undefined;
    cultural_notes?: string | undefined;
}, {
    word: string;
    level: string;
    translation: {
...
export declare const vocabularyListSchema: z.ZodObject<{
    words: z.ZodArray<z.ZodObject<{
        thai: z.ZodString;
        ipa: z.ZodString;
        translation: z.ZodString;
        example: z.ZodString;
        exampleTranslation: z.ZodString;
    }, "strip", z.ZodTypeAny, {
        thai: string;
        translation: string;
        ipa: string;
...
export declare const wordQuizQuestionSchema: z.ZodObject<{
    ...
    correct_answer: z.ZodEnum<["A", "B", "C", "D"]>;
    type: z.ZodEnum<["meaning", "usage", "synonym", "antonym", "fillBlank"]>;
    about: z.ZodString;
}, "strip", z.ZodTypeAny, {
    options: {
        id: "A" | "B" | "C" | "D";
    ...
    type: "usage" | "meaning" | "synonym" | "antonym" | "fillBlank";
    question: string;
...
export declare const wordQuizListSchema: z.ZodObject<{
...
export declare const WORD_QUIZ_PROMPT = "Generate a complete set of Thai vocabulary exercises in JSON format. For each given Thai word/phrase, create five multiple-choice questions covering meaning, usage, synonym, antonym, and a fill-in-the-blank context.\n\n**Question Types per Word:**\n\n1. Meaning Comprehension Question:\n- Question format: \"\u0E04\u0E33\u0E27\u0E48\u0E32 '[Thai word]' \u0E2B\u0E21\u0E32\u0E22\u0E04\u0E27\u0E32\u0E21\u0E27\u0E48\u0E32\u0E2D\u0E22\u0E48\u0E32\u0E07\u0E44\u0E23?\"\n- Present 4 options in English (Targeting Chinese students at an A2-B1 level).\n- Set \"type\" to \"meaning\".\n\n2. Usage in Context Question:\n- Question format: \"\u0E1B\u0E23\u0E30\u0E42\u0E22\u0E04\u0E43\u0E14\u0E43\u0E0A\u0E49\u0E04\u0E33\u0E27\u0E48\u0E32 '[Thai word]' \u0E16\u0E39\u0E01\u0E15\u0E49\u0E2D\u0E07?\"\n- Present 4 complete Thai sentences as options. Only one sentence must correctly use the word.\n- Set \"type\" to \"usage\".\n\n3. Synonym Question:\n- Question format: \"\u0E04\u0E33\u0E43\u0E14\u0E40\u0E1B\u0E47\u0E19\u0E04\u0E33\u0E1E\u0E49\u0E2D\u0E07\u0E04\u0E27\u0E32\u0E21\u0E2B\u0E21\u0E32\u0E22 (\u0E04\u0E33\u0E40\u0E2B\u0E21\u0E37\u0E2D\u0E19) \u0E01\u0E31\u0E1A\u0E04\u0E33\u0E27\u0E48\u0E32 '[Thai word]'?\"\n- Present 4 Thai vocabulary options. If the word has no absolute synonym, use a contextually close word. If it's impossible to create one, return an empty array for this specific question object or omit it.\n- Set \"type\" to \"synonym\".\n\n4. Antonym Question:\n- Question format: \"\u0E04\u0E33\u0E43\u0E14\u0E40\u0E1B\u0E47\u0E19\u0E04\u0E33\u0E15\u0E23\u0E07\u0E02\u0E49\u0E32\u0E21\u0E01\u0E31\u0E1A\u0E04\u0E33\u0E27\u0E48\u0E32 '[Thai word]'?\"\n- Present 4 Thai vocabulary options.\n- Set \"type\" to \"antonym\".\n\n5. Fill-in-the-Blank Question:\n- Create a natural Thai sentence and replace the target word with a blank placeholder like \"______\".\n- Question format: \"\u0E08\u0E07\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E04\u0E33\u0E15\u0E2D\u0E1A\u0E17\u0E35\u0E48\u0E16\u0E39\u0E01\u0E15\u0E49\u0E2D\u0E07\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E40\u0E15\u0E34\u0E21\u0E43\u0E19\u0E0A\u0E48\u0E2D\u0E07\u0E27\u0E48\u0E32\u0E07: [Sentence with ______]\"\n- Present 4 Thai vocabulary options.\n- Set \"type\" to \"fillBlank\".\n\n**Requirements:**\n- Test level: A2 students learning B1 vocabulary. All Thai sentences should use simple grammar and vocabulary suitable for A2 level learners.\n- Output format: Strict JSON Array containing all generated question objects. Shuffle the sequence of the JSON array so questions of the same word or type are not all grouped together. For each quiz, set \"about\" to the thai word to be tested\n- Create these exercises for the following Thai words: [[thWords]]";
